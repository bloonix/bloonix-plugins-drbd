Summary: Bloonix plugins to check DRBD.
Name: bloonix-plugins-drbd
Version: 0.8
Release: 1%{dist}
License: Commercial
...
%description
bloonix-plugins-drbd provides plugins to check DRBD vitals.
...
* Mon Nov 03 2014 Jonny Schulz <js@bloonix.de> - 0.7-1
- Updated the license information.
* Tue Aug 26 2014 Jonny Schulz <js@bloonix.de> - 0.6-1
- Licence added and old releases deleted.
* Tue Aug 26 2014 Jonny Schulz <js@bloonix.de> - 0.6-1
- Licence added and old releases deleted.
* Sat Mar 23 2014 Jonny Schulz <js@bloonix.de> - 0.5-1
- Complete rewrite of all plugins.
* Tue Sep 18 2012 Jonny Schulz <js@bloonix.de> - 0.2-1
- Fixed a bug in check-drbd. DRBD devices 0 are
  not skipped any more.
- Initial release.
